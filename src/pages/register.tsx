...
function Register() {
	...
	function onSubmit(values: z.infer<typeof formSchema>) {
		...
		axios
			...
			.then(res => {
				toast.success(
					'Tizimga muvaffaqiyatli ro&lsquo;yhatdan o&lsquo;tdingiz!',
					{
						position: 'top-center',
						richColors: true,
					}
	...
	return (
		<div className='fixed top-0 left-0 w-screen h-screen overflow-hidden flex items-center justify-center'>
			<Card className='w-full max-w-sm'>
				<CardHeader>
					<CardTitle>Tizimga ro&lsquo;yhatdan o'tish</CardTitle>
					<CardDescription>
						Tizimga ro&lsquo;yhatdan o'tish uchun email va parolingizni kiriting
					</CardDescription>
					<CardAction>
						<Link to={'/login'}>
							<Button variant='link'>Kirish</Button>
						</Link>
					</CardAction>
				</CardHeader>
				<Form {...form}>
